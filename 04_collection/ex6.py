...
d.update(d2)
# 원본 변환. upsert(key값이 없으면 추가, 이미 있으면 수정 ex: age 5 -> age 23)
print(d)
...
print({**d})  # key랑 value를 둘 다 꺼냄

d2 = {"eng": 90, "sci": 95}
print({**d, **d2})  # update와 결과는 동일 -> but 내부적으로는 새로운 개체 생성
...
# 3) Counter: 요소의 빈도수를 세어주는 딕셔너리의 서브 클래스
...
r1 = {k: "합격" for k, v in scores.items() if v >= 60}
print(r1)  # ✅ {'국어': '합격', '수학': '합격', '사회': '합격'}
