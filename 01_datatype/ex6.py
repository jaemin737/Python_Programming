...
s = "1316"
print(f"{s[0]}학년 {s[1]}반 {s[2]}{s[3]}번")  # ✅ "1학년 3반 16번" 출력
s = "1301"
print(f"{s[0]}학년 {s[1]}반 {(s[2]+s[3]).strip("0")}번")  # ✅ "1학년 3반 1번" 출력

# 2️⃣ 학번을 슬라이싱만을 이용해서 학년, 반, 번호로 잘라내기
print(f"{s[0]}학년 {s[1]}반 {s[2:].strip("0")}번")  # ✅ "1학년 3반 1번" 출력
s = "1316"
print(f"{s[0]}학년 {s[1]}반 {s[2:].strip("0")}번")  # ✅ "1학년 3반 16번" 출력
